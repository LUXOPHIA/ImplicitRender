...
type //$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$【型】
     ...
     public
       ...
       property Phase :TShaderVarSingle  read _Phase;
     end;
     ...
     protected
       ...
       procedure SetPhase( const Phase_:Single );
     public
       ///// プロパティ
...
begin
     ...
     _Phase     := TShaderVarSingle  .Create( '_Phase'    );
...
function TMyMaterialSource.GetPhase :Single;
begin
     Result := _Material.Phase.Value;
end;

procedure TMyMaterialSource.SetPhase( const Phase_:Single );
begin
     _Material.Phase.Value := Phase_;
end;
...
procedure TMathCube.SetWidth( const Value_:Single );
begin
     inherited;
...
procedure TMathCube.SetHeight( const Value_:Single );
begin
     inherited;
...
procedure TMathCube.SetDepth( const Value_:Single );
begin
     inherited;
...
constructor TMathCube.Create( Owner_:TComponent );
begin
     inherited;
